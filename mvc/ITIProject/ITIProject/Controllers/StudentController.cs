...
namespace ITIProject.Controllers
{
    public class StudentController : Controller
    {
        ...
        public StudentController(IStudentRepo _studentRepo, IDepartmentRepo _departmentRepo, ICourseRepo _courseRepo)
        {
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.crs = new SelectList(courseRepo.GetAll(), "CourseId", "CourseName");
