namespace menu_Dauy5
{
    ...
    class sortnameasc : IComparer<Employee>
    {
    ...
    class sortnamedesc : IComparer<Employee>
    {
        public int Compare(Employee? x, Employee? y)
        {
    ...
    class sortsalarydesc : IComparer<Employee>
    {
        public int Compare(Employee? x, Employee? y)
        {
                                ...
                                case 1:
                                    ...
                                    if (sortby == "Salary")
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            arremp.Sort(new sortsalarydesc());
                                            arremp.Display();
                                        }
                                    }
                                    else if (sortby == "Name")
                                    {
                                        ...
                                        if (order == "Asc")
                                        {
                                            ...
                                            arremp.Sort(new sortnameasc());
                                            arremp.Display();
                                        }
                                        else
                                        {
                                            Console.WriteLine("Sort By Name Desc");
                                            arremp.Sort(new sortnamedesc());
                                            arremp.Display();
                                        }
                                    }
                                    break;
